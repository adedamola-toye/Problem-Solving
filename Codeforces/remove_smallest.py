...
#check if 2 neighbouring elements are within 1. 
#If they are i.e if all close elements are, then it's possible.
#But if there is even just 2 neighbouring elements that do not fit the condition, it is not possible